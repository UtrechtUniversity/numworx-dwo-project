...
-keep class fi.dwo.client.system.text.* {
    <fields>;
    <methods>;
}
...
-keep class fi.dwo.client.system.*{
    <fields>;
    <methods>;
}

-keep class fi.dwo.client.persistence.AppletMapper{
    <methods>;
}
-keep class fi.dwo.client.persistence.UserMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.User
-keep class fi.dwo.client.persistence.SchoolMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.School
-keep class fi.dwo.client.persistence.GroupMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.Group
-keep class fi.dwo.client.persistence.SchoolGroupMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.SchoolGroup
-keep class fi.dwo.client.persistence.CourseMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.Course
-keep class fi.dwo.client.persistence.ScoMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.Sco
-keep class fi.dwo.client.persistence.ClassMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.SchoolClass
-keep class fi.dwo.client.persistence.UserResultListMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.UserResultList
-keep class fi.dwo.client.domain.ResultsModuleIF

-keep class fi.dwo.client.persistence.AppletConfigMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.AppletConfig
-keep class fi.dwo.client.persistence.DwoProfileMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.DwoProfile
-keep class fi.dwo.client.persistence.AppletDataMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.AppletData
-keep class fi.dwo.client.persistence.CourseSequenceMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.CourseSequence
-keep class fi.dwo.client.persistence.ClassCourseMapper{
    <methods>;
}
-keep class fi.dwo.client.domain.ClassCourse
-keep class fi.dwo.client.persistence.XmlRpcMapper{
    <fields>;
    <methods>;
}
