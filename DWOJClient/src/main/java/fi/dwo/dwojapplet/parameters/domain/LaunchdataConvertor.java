 ...
 * hashtables) to launchdata which applets understands (without hashtables).
 *
 * @author M.J.B. Kupers
 *
 */
public class LaunchdataConvertor implements ConvertorIF {
    ...
    /**
     * All the items in the tree are grouped together in one hashtable and
     * returned. If this is a nested-tree. The nested numbers are removed.
     *
     * @param parameter
     * @param srcPrefix
     * @param nrPrefix
    ...
    /**
     * Converts the parameters-launchdata to the correct DWO-launchdata. The
     * return value is a hashtable where all the items (also tree items) are
     * mapped.
     *
     * @param launchdata
     * @param parameters
