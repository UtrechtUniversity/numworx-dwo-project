...
public class DwoButton extends BorderedPanel implements MouseListener, FocusListener, KeyListener {
     ...
     * @see
     * fi.dwo.client.gui.CourseIconIF#addActionListener(java.awt.event.ActionListener)
     */
    ...
    /**
     * Gets the mininimum size of this component. The minimum size is the
     * current size.
     *
     ...
     *
     * Op de Apple met safari, ontbreekt dit event als het scherm geen focus
     * heeft
     *
     * @param e
