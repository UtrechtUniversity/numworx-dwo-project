...
StudentsInSchoolclassDisplay.prototype.updateView = function() {
	console.log("updateView");
}

StudentsInSchoolclassDisplay.prototype.updateSchoolClasses = function() {
	console.log("updateSchoolClasses");
}
