...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "writemathgwt" because\n';
  ...
  $wnd.__gwt_activeModules['writemathgwt'] = {
    'moduleName' : 'writemathgwt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/writemathgwt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['writemathgwt'].superdevmode = true;

  var expectedSuffix = '/writemathgwt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + writemathgwt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:writemathgwt';
  var devModeSessionKey = '__gwtDevModeSession:writemathgwt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/writemathgwt/writemathgwt.nocache.js';
  ...
  $wnd.__gwt_activeModules['writemathgwt'].canRedirect = true;
  $wnd.__gwt_activeModules['writemathgwt'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING writemathgwt';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/writemathgwt?user.agent=' + ua + '&_callback=' + callback;
