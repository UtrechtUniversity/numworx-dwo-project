...
%>
<a href='sebs://<%=server %>/wa/exam/<%=leerling %>.seb'>Start de beveiligde <strong>toets</strong> omgeving</a>

<%    if (System.getProperty("DWO_ENV", "").contains("test")) { %>
<br><a href='sebs://<%=server %>/wa/exam/<%=leerling %>.seb?with=entree'>Start de beveiligde <strong>toets</strong> omgeving</a> via Entree
