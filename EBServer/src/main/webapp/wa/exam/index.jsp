...
%>
<a href='sebs://<%=server %>/wa/exam/<%=leerling %>.seb<%=code%>'>Start de beveiligde <strong>toets</strong> omgeving</a>

<%
	} else {
%>
	  <a target='_top' href='/wa/exam/toets.jsp<%=id%><%=code%>'>Start de beveiligde <strong>exam</strong> omgeving</a>
<% }
