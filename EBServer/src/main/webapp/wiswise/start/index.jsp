...
<% 
	...
	if(Util.illegal(query))
	 	query = "?base=/wiswise/start/&header=less&profile=" + profile;
	else 
	  	query = "?base=/wiswise/start/&header=less&profile=" + profile + "&" + query;
	String player, hash;

		player = "/dwo/tablet/DWOplayer.jsp";
		hash = System.getProperty("WISWISE_START", "#s:616620");
%>
