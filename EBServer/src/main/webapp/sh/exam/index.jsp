...
%>
<a href='sebs://<%=server %>/sh/exam/<%=leerling%>.seb<%=code%>'>Start the safe <strong>exam</strong> environment</a>
<%
	} else {
%>
	  <a href='/sh/exam/toets.jsp<%=id%><%=code%>' target='_top'>Start the safe <strong>exam</strong> environment</a>
<%	  
	}
