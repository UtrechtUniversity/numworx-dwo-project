...
<% 
	...
	if(Util.illegal(query))
	 	query = "?base=/digtep/start/&header=less&profile=" + profile;
	else 
	  	query = "?base=/digtep/start/&header=less&profile=" + profile + "&" + query;
	String player, hash;

		player = "/dwo/tablet/DWOplayer.jsp";
		hash = System.getProperty("DIGTEP_START", "#s:615936");
%>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		<meta name="apple-mobile-web-app-capable" content="yes">
		<meta name="viewport" content="width=1078">
        <title>Numworx Interactive Virtual Math</title>
		<style type="text/css">
            body, html
            {
