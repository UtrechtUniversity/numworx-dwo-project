...
public class CopyOfDWOTabletKeyboardGrUpper extends AbstractKeyboard {
	...
	interface TabletKeyboardUpperUiBinder extends
			UiBinder<Widget, CopyOfDWOTabletKeyboardGrUpper> {
	}

	public CopyOfDWOTabletKeyboardGrUpper() {
