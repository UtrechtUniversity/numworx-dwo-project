...
public class TabletKeyboard extends AbstractKeyboard {
	...
	@UiHandler("t1_6") void onT1_6(ClickEvent e) {getEditor().kwadraat();}
	@UiHandler("t1_7") void onT1_7(ClickEvent e) {getEditor().macht();}
	@UiHandler("t1_8") void onT1_8(ClickEvent e) {getEditor().subscript();}
	@UiHandler("t1_9") void onT1_9(ClickEvent e) {getEditor().limiet0();}
	@UiHandler("t1_10") void onT1_10(ClickEvent e) {getEditor().insert('∞');}
	@UiHandler("t1_11") void onT1_11(ClickEvent e) {getEditor().insert(" of ");}
