...
public interface Dwo2ExceptionMessages extends com.google.gwt.i18n.client.ConstantsWithLookup {
  ...
  /**
   * Translated "Object already exists. Please refresh your data to view.".
   * 
   * @return translated "Object already exists. Please refresh your data to view."
   */
  @DefaultStringValue("Object already exists. Please refresh your data to view.")
  @Key("Dwo2ExceptionCode.Rest_ObjectAlreadyExists")
  String Dwo2ExceptionCode_Rest_ObjectAlreadyExists();
  ...
  /**
   * Translated "Invalid full name entered.".
   * 
   * @return translated "Invalid full name entered."
   */
  @DefaultStringValue("Invalid full name entered.")
  @Key("Dwo2ExceptionCode.Rest_Registration_Invalid_Full_Name")
  String Dwo2ExceptionCode_Rest_Registration_Invalid_Full_Name();
  ...
  /**
   * Translated "Our system is currently unavailable due to emergency maintenance. See www.dwo.nl for more information.".
   * 
   * @return translated "Our system is currently unavailable due to emergency maintenance. See www.dwo.nl for more information."
   */
  @DefaultStringValue("Our system is currently unavailable due to emergency maintenance. See www.dwo.nl for more information.")
  @Key("Dwo2ExceptionCode.Rest_SystemHasEmergencyMaintenance")
  String Dwo2ExceptionCode_Rest_SystemHasEmergencyMaintenance();

  /**
   * Translated "Our system is currently unavailable due to scheduled maintenance. See www.dwo.nl for more information.".
   * 
   * @return translated "Our system is currently unavailable due to scheduled maintenance. See www.dwo.nl for more information."
   */
  @DefaultStringValue("Our system is currently unavailable due to scheduled maintenance. See www.dwo.nl for more information.")
  @Key("Dwo2ExceptionCode.Rest_SystemHasScheduledMaintenance")
  String Dwo2ExceptionCode_Rest_SystemHasScheduledMaintenance();
  ...
  /**
   * Translated "The date string entered is not a valid date string.".
   * 
   * @return translated "The date string entered is not a valid date string."
   */
  @DefaultStringValue("The date string entered is not a valid date string.")
  @Key("Dwo2ExceptionCode.User_NotAValidDateString")
  String Dwo2ExceptionCode_User_NotAValidDateString();
