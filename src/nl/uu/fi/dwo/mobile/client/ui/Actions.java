...
public enum Actions {
  showMainNav, hideMainNav, isMainNavVisible, RESULTS, KNOWLEDGE, PERSONS, SCHOOLCLASSES, ORGANISATION, ARROWUP, TRAIL, LOGOUT, EXAM, MAYBELOGOUT, CLOSING, LOGINNEEDED;
