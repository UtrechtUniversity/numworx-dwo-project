...
public class SlidingPopup extends SimplePanel implements 
    EventPreview, HasAnimation, HasCloseHandlers<SlidingPopup> {
  ...
  public static enum AnimationType {
    CENTER, ONE_WAY_CORNER, ROLL_DOWN, SLIDING
  }
  ...
  static class ResizeAnimation extends Animation {
     ...
     */
    private SlidingPopup curPanel = null;
     ...
     */
    public ResizeAnimation(SlidingPopup panel) {
      this.curPanel = panel;
    }
...
// EXTRA
   ...
   * to animate menus.
   */
  private AnimationType animType = AnimationType.SLIDING;
   ...
   *          changes.
   */
  public SlidingPopup(boolean autoHide) {
    this();
   ...
   */
  public SlidingPopup(boolean autoHide, boolean modal) {
    this(autoHide);
    this.modal = modal;
  }
  ...
  public HandlerRegistration addCloseHandler(CloseHandler<SlidingPopup> handler) {
