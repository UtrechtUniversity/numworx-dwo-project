...
public class TekstBuffer
{
	...
	{	ArrayList<Object> result = new ArrayList<Object>();
		...
		{	ArrayList<ArrayList<Object>> teksten = (ArrayList<ArrayList<Object>>)(opdracht.get("teksten"));
			if(teksten!=null)tekst = (String)(teksten.get(row)).get(column);
	...
	{	Object result = null;
		...
		if(opdrachtGegevens.size() > index+1)currentVakGegevens = (HashMap<String, Object>) opdrachtGegevens.get(index + 1);
