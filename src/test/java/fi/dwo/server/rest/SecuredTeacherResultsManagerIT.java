...
//        assertEquals(true, result.getStudentsOfClasses().containsKey(new MySQLPersistenceId("MYSQL;PersistentStudentOfClass;00000000000000000009;00000000000000000002;00000000000000000002")));
