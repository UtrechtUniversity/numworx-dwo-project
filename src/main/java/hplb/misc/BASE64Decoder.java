/*
 * $Id: BASE64Decoder.java,v 1.4 1997/06/19 08:33:11 ak Exp $
 * 
...
/**
 * A BASE64 decoder. BASE64 is a simple encoding defined by the IETF as part of
...
public class BASE64Decoder extends CharacterDecoder {
    ...
    /**
     * Base64 decodes the specified InputStream and writes result onto the
     * OutputStream.
     *
    ...
    /**
     * Read single char from the InputStream but ignores anything which isn't in
     * the BASE64 alphabet.
     *
     * @return
     */
