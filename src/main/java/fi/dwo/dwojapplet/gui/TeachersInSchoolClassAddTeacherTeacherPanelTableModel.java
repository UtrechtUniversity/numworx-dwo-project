 ...
 */
class TeachersInSchoolClassAddTeacherTeacherPanelTableModel extends AbstractTableModel {

    private String[] columnNames = {"usernaam", "given name", "insertion", "familyname", "delete"};
    static boolean DEBUG = false;
    private TeachersInSchoolClassAddTeacherTeacherPanelProperties prop;

    private int selectedRow, selectedColumn;

    private Object[][] data;

    public void init(TeachersInSchoolClassAddTeacherTeacherPanelProperties props, DomSchoolClass sc, Image addImage) throws Dwo2Exception {

        prop = props;
        List<DomTeacher> userList = prop.getTeachersInSchoolNotInClass(sc);
        int rows = 0;
        if (userList == null) {
