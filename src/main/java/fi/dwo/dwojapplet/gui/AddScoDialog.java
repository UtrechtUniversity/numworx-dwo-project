...
/**
 * This class shows in a dialog a list with all the possible
 * <code>AppletConfig</code>'s.<br>
 * The user can choose one AppletConfig and at a confirm the
 * <code>ScoNameDialog</code> is showed.
 *
 * @author M.J.B. Kupers
 *
 */
...
//        contentPane.setPreferredSize(contentPane.getSize());
    ...
    /**
     * Een dialogbox met twee extra radiobuttons voor eigen en algemene
     * activiteiten.
     *
     * @param owner
     * @param ac
...
// FIXME: i18n
    ...
    /**
     * Show only the AppletConfigs where the name starts with the specified
     * String.
     *
     * @param s The string to compare with the AppletConfig name. If the name
     * starts with s, the AppletConfig is showed.
     */
     ...
     * Creates a new Sco in the specified Course.
     *
     * @param owner The parent of the dialog witch is showed to create the new
     * Sco.
     * @param course The course where the new Sco must be created.
     * @return The new Sco.
     */
