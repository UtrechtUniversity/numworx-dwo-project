 ...
 */
public class SchoolClassesSchoolAdminPanel extends JPanel implements CenterSubPanel, ActionListener {

    private static final Logger LOG = Logger.getLogger(SchoolClassesSchoolAdminPanel.class.getName());

    private SchoolClassesSchoolAdminPanelProperties prop = new SchoolClassesSchoolAdminPanelProperties();
    private SchoolClassesSchoolAdminPanelTableModel tableModel;
...
//            final GuiCreator instance = GuiCreator.instance();
    ...
    private void buildJTable() throws Dwo2Exception {
        ...
        tableModel = new SchoolClassesSchoolAdminPanelTableModel();
        ...
        TableUtil.setDefaults(jtable, true, new SchoolClassesSchoolAdminPanel.ImageRenderer(), new SchoolClassesSchoolAdminPanel.ImageButtonEditor());
...
//        jtable.setMaximumSize(size);
     ...
     *
     */
    public SchoolClassesSchoolAdminPanel() throws Dwo2Exception {
        super(null);
