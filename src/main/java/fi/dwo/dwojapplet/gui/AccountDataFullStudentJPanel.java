 ...
 *
 */
public class AccountDataFullStudentJPanel extends JPanel implements
        ActionListener {

    private static final Logger LOG = Logger.getLogger(AccountDataFullStudentJPanel.class.getName());
...
//    protected User user;
     ...
     *
     */
    public AccountDataFullStudentJPanel() {
        try {
            prop.init();
        }
...
//                    }
//                    catch (Dwo2Exception ex) {
//                        Logger.getLogger(AccountDataFullStudentJPanel.class.getName()).log(Level.SEVERE, null, ex);
