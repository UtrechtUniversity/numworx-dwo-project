 ...
 */
class SchoolClassesSchoolAdminPanelTableModel extends AbstractTableModel {
    ...
    private SchoolClassesSchoolAdminPanelProperties prop;

    private int selectedRow, selectedColumn;

    private Object[][] data;

    public void init(SchoolClassesSchoolAdminPanelProperties props, Image editClassImage, Image editStudentsImage, Image editTeachersImage, Image removeImage) throws Dwo2Exception {

        prop = props;
        List<DomSchoolClass> scList = prop.getSchoolClassList();
        int rows = 0;
        if (scList == null) {
        ...
        for (DomSchoolClass sc : scList) {
            ...
            data[j][1] = editClassImage;
            data[j][2] = editStudentsImage;
            data[j][3] = editTeachersImage;
