...
class ClassTeacherPanelTableModel extends AbstractTableModel {
    ...
    public void init(ClassTeacherPanelProperties props, Image editClassImage, Image editModulesImage, Image editStudentsImage, Image editTeachersImage, Image removeImage) throws Dwo2Exception {
        ...
        for (DomSchoolClass sc : scList) {
            ...
            data[j][2] = editModulesImage;
            data[j][3] = editStudentsImage;
            data[j][4] = editTeachersImage;
