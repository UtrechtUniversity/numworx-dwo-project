...
// *
// */
//public class ClassStudentPanel_old extends JPanel implements CenterSubPanel, ActionListener {
//
...
//				int result = JOptionPane.showConfirmDialog(ClassStudentPanel_old.this, panel ,TextMapper.getText(TextMapper.GUIC_MSG_CLASS_CONFIGURATION),
...
//                /* Delete the course */
//                if (JOptionPane.showConfirmDialog(ClassStudentPanel_old.this, TextMapper.getText(TextMapper.GUIC_MSG_DELETE_CLASS)
