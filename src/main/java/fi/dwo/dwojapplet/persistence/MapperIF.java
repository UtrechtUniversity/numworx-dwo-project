...
/**
 * A mapper which can map database-hashtables on objects.
...
public interface MapperIF {
     ...
     * e.g. if this is a CourseMapper and the objectID is 1,
     ...
     * e.g. if this is the CourseMapper,
    ...
    /**
     * Creates an object out of the Hashtable.
     * If this is the CourseMapper, a Course-Object will be returned.
    ...
    /**
     * Creates all the objects out of the Vector.
     * If this is the CourseMapper, Course-Objects will be returned.
    ...
    /**
     * Returns all the objects whith the object as restriction.
     * If this is the CourseMapper, Course-Objects will be returned. A restriction could be a school.
     * Only the courses for the specific are returned.
     * Which objects can be specified as a restriction are definied at the Mapper-Specific documentation.
     * 
