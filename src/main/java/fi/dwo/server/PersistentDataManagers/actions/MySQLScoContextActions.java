...
class MySQLScoContextActions {
  ...
  public static DomScoContextFull update(PersistentScoContext pc, PersistentScoData sd,
    ...
    try {
      ...
      if (scoContext.getImageData() != null) {
        ...
        switch (id.getType()) {
          case PersistentScoContext:
            if (id.equals(scoContext.getId())) break;
            // TODO Zie "add"
          default:
      ...
      if (scoData != null) {
        if (scoData.getLaunchdata() != null) sd.setLaunchdata(scoData.getLaunchdata());
  ...
  static DomScoContextFull add(PersistentCourse c, DomScoContextFull scoContext,
    ...
    try {
      ...
      if (scoType == null) scoType = ScoType.OEFENEN; // NotNull!
      pc.setScoType(scoType);
      Boolean showscore = scoContext.getShowScore();
      if (showscore == null) showscore = Boolean.TRUE; // notnull?
