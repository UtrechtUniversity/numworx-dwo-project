...
//                    long scoID = list.get(0);
                    javax.persistence.Query results = em.createQuery(
                            "SELECT ssco.persistentHasRolePK.userID FROM PersistentCourse c, PersistentClassCourse cc, PersistentStudentOfClass soc, PersistentScoContext sco, PersistentStudentScoContext ssco WHERE cc.courseID=:courseID and cc.classID=:classID and soc.persistentStudentOfClassPK.userID = ssco.persistentHasRolePK.userID and soc.persistentStudentOfClassPK.schoolGroupID = ssco.persistentHasRolePK.schoolGroupID and soc.persistentStudentOfClassPK.classID = cc.classID and  = sco.scoID and sco.courseID = c.courseID and c.courseID=:courseID");
