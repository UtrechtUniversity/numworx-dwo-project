 ...
 */
@PermitAll
@Path("/secure/teacher/classcourse")
public class SecuredTeacherClassCourseManager {

    private static final Logger LOG = Logger.getLogger(SecuredTeacherClassCourseManager.class.getName());

    
    @PUT
    @Path("update")
    @Produces({"application/json"})
    public DomClassCourseFull update(@Context SecurityContext sc, RestClassCourseFull rest) {
