...
public class Text_en extends ListResourceBundle {
	...
	private final Object[][] contents = {
			...
			{ TextMapper.TBL_CLASSLIST, "classeslist" },
			...
			{ TextMapper.GUIC_TBL_CLASSNAME, "Schoolclass name" },
			{ TextMapper.GUIC_BTN_SWITCH_CLASS, "Switch to schoolclass" },
			...
			{ TextMapper.GUIC_MSG_CLASS_CONFIGURATION, "Schoolclass configuration" },
                        { TextMapper.GUIC_MSG_CLASS_NAME, "Schoolclass name"},
                        { TextMapper.GUIC_MSG_CLASS_REGISTRATIONKEYQ, "Use a registrationkey?"},
                        { TextMapper.GUIC_MSG_CLASS_REGISTRATIONKEY, "Registrationkey"},
                        { TextMapper.GUIC_MSG_CLASS_REGISTRATIONKEY_TOOLTIP, "The registration key can be between 5 and 100 characters long."},
                        { TextMapper.GUIC_MSG_CLASS_TREESTRUCTURE, "Use a treestructure?"},
