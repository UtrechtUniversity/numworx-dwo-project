...
public class Text_en extends ListResourceBundle {
	...
	private final Object[][] contents = {
			...
			{ TextMapper.LBL_CLICK_TO_SELECT_A_SCHOOLCLASS, "Select a school class." },
			...
			{ TextMapper.GUIC_TBL_CLASSNAME, "Cclass name" },
