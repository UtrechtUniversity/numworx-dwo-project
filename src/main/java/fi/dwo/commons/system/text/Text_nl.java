...
public class Text_nl extends ListResourceBundle {
	...
	private final Object[][] contents = {
			...
			{ TextMapper.TBL_EDITCLASS, "edit klas" },
			...
			{ TextMapper.DLG_DONE_MSG, "Verzochte taak uitgevoerd." },
                        { TextMapper.DLG_LOSE_NEW_STUDENT_ACCOUNTS, "U heeft nog ongeregistreerde studenten in uw lijst. Doorgaan?" },                        
			{
					TextMapper.DLG_CREATESTUDENTERROR,
					"De overgebleven studenten kunnen niet worden toegevoegd, vermoedelijk is de username niet uniek." },
			{TextMapper.DLG_COPYSTUDENTERROR,"Sommige studenten konden niet in de klas worden geplaatst, mogelijk zaten ze er al in."},
