...
public class PersistenceIdFactory {
    ...
    //in case there are more than one type of PersistenceId's.
    private static PersistenceIdFactory instance = new PersistenceIdFactory();
//    private static PersistenceId idInstance;
    
    /**
     * 
     * @param o
     * @return a PersistenceId or null incase of an unsupported type.
     */
    public static PersistenceId createPersistenceId(Object o){
        ...
        log.log(Level.SEVERE,"Factory was asked to store a unsupported data type.");
        return null;
    }
...
//    public static PersistenceId createPersistentId(PersistentDwoSystemParameters o) {
//        return (PersistenceId) MySQLPersistenceId.createPersistentId(o);
//    }
...
//    public static PersistenceId createPersistentId(PersistentImage o) {
//        return (PersistenceId) MySQLPersistenceId.createPersistentId(o);
//    }

//    public static PersistenceId createPersistentId(PersistentJars o) {
//        return (PersistenceId) MySQLPersistenceId.createPersistentId(o);
//    }
