...
public class MySQLPersistenceId extends PersistenceId implements Comparable<PersistenceId> {
	...
	/**
	 * This constructor is only public because of jax-rs. Use a factory to generate
	 * id's.
	 *
	 * @param pid
	 */
	...
	public static Long getNativeId(DomAppletConfigDataId o) throws Dwo2Exception {
		if (o == null)
			return null;
		return getSingleNativeId(o.getId().getIdString(), PersistenceClassType.PersistentAppletConfigData);
	}
	...
	/**
	 * A class that overrides equals must override hashCode for HasMaps and such to
	 * work properly.
	 */
	@Override
	public int hashCode() {
