...
public class PointMatch implements Serializable
{
	 ...
	 * Constructor
	 *
	 * Create a {@link Point2dMatch} with an Array of weights.
	 * The Array of weights will be copied.
	 *
	 * @param p1 Point 1
	 * @param p2 Point 2
...
//	}
	...
	final public static void sourcePoints( final Collection< PointMatch > matches, final Collection< Point2d > sourcePoints )
	{
		for ( final PointMatch m : matches )
			sourcePoints.add( m.getP1().clone() );
	}

	final public static void cloneSourcePoints( final Collection< PointMatch > matches, final Collection< Point2d > sourcePoints )
	{
		for ( final PointMatch m : matches )
			sourcePoints.add( m.getP1().clone() );
	}

	final public static void targetPoints( final Collection< PointMatch > matches, final Collection< Point2d > targetPoints )
	{
		for ( final PointMatch m : matches )
			targetPoints.add( m.getP2() );
	}

	final public static void cloneTargetPoints( final Collection< PointMatch > matches, final Collection< Point2d > targetPoints )
	{
		for ( final PointMatch m : matches )
