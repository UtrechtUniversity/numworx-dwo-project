...
class FormuleContext implements ViewFactory {
    ...
    private static final Logger log = Logger.getLogger(TableDataView.class.getName());
...
//r.alignment: center at height of '-': strikethrough offset
    ...
    static class FormuleView extends BoxView {
        ...
        /**
         * Fetch the font that the glyphs should be based upon. This is
         * implemented to call <code>StyledDocument.getFont</code> if the
         * associated document is a StyledDocument. If the associated document
         * is not a StyledDocument, the associated components font is used. If
         * there is no associated component, null is returned.
         */
        public Font getFont() {
        ...
        /**
         * Fetch the foreground color to use to render the glyphs. If there is
         * no foreground color, null should be returned. This is implemented to
         * call <code>StyledDocument.getBackground</code> if the associated
         * document is a StyledDocument. If the associated document is not a
         * StyledDocument, the associated components foreground color is used.
         * If there is no associated component, null is returned.
         */
    ...
    static class MfencedView extends RowView {
        ...
        MfencedView(Element elem) {
            ...
            if (!attributes.isDefined("open")) {
                str = "(";
            } else {
                str = (String) attributes.getAttribute("open");
            }
            open = str;
            if (!attributes.isDefined("close")) {
                str = ")";
            } else {
                str = (String) attributes.getAttribute("close");
            }
            close = str;
        }
