 ...
 * redistribute this software in source and binary code form, provided that * i)
 * this copyright notice and license appear on all copies of the software; * and
 * ii) Licensee does not utilize the software in a manner which is * disparaging
 * to ADL Co-Lab. * * This software is provided "AS IS," without a warranty of
 ...
 * A PARTICULAR PURPOSE * OR NON-INFRINGEMENT, ARE HEREBY EXCLUDED. ADL Co-Lab
 * AND ITS LICENSORS * SHALL NOT BE LIABLE FOR ANY DAMAGES SUFFERED BY LICENSEE
 * AS A RESULT OF * USING, MODIFYING OR DISTRIBUTING THE SOFTWARE OR ITS
 * DERIVATIVES. IN NO * EVENT WILL ADL Co-Lab OR ITS LICENSORS BE LIABLE FOR ANY
 ...
 * as defined in the SCORM Version 1.2.<br><br>
 *
...
public interface SCORM12APIInterface {
     ...
     * to determine:
     * <ul>
     * <li> Values for various categories (groups) and elements in the data
     * model</li>
     ...
     * comma-separated list of all of the element names in the specified group
     * or category that are supported by the LMS. If an element has no children,
     * but is supported, an empty string ("") is returned. An empty string ("")
     * is also returned if an element is not supported. A subsequent request for
     * last error [LMSGetLastError()] can determine if the element is not
     * supported. The error "401 Not implemented error" indicates the element is
     * not supported.</li>
     ...
     *
     * @param iDataModelElement
     * @param iValue This is the name of a fully qualified element defined in
     * the data model. The argument is case sensitive. The argument is a string
     * enclosed in quotes. The following represents some forms this parameter
     * may take.
     * <ul>
     * <li>datamodel.element This is the name of a category or group defined in
     * the Data Model. An example is "cmi.comments".</li>
     * <li>datamodel.group.element This is the name of an element defined in the
     * Data Model. An example is
     * "cmi.core.lesson_status".datamodel.group.n.element The value of the
     * sub-element in the nth-1 member of the element array (zero-based indexing
     * is used).</li>
     * </ul>
     *
     * @return String representing a boolean
