...
public class SecureDwoAdminSchoolManager {
    ...
    public static Boolean updateSchool(DomSchoolFull submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/dwoadmin/school/update", Boolean.class, rest);
    ...
    public static Boolean removeSchool(DomSchool4DwoAdmin submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/dwoadmin/school/remove", Boolean.class, rest);
        LOG.log(Level.FINE, "Submitted school {1} for removal by user with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), submit.getId()});
        return result;
    }
    ...
    public static Boolean submitSchool(DomSchoolFull submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/dwoadmin/school/submit", Boolean.class, rest);
        LOG.log(Level.FINE, "Submitted school with login {1} to be added by dwoadmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), submit.getId()});
        return result;
    }
    ...
    public static List<DomTeacherAndHasRole> getTeachersAndHasRoleInSchool(DomSchool4DwoAdmin domSchool) throws Dwo2Exception {
        ...
        result = StoredRestManager.getInstance().getPutList("rest/secure/dwoadmin/school/getTeachersAndHasRoleInSchool", RestListClassTypes.DomTeacherAndHasRole, rest);
        LOG.log(Level.FINE, "Retrieved list of teachers and hasRoles in the school {1} for the dwoadmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), domSchool.getId()});
        return result;
    }
