...
public class SecureSchoolAdminSchoolManager {
    ...
    public static List<DomSchoolAdmin> getSchoolAdminsInSchool() throws Dwo2Exception {
        ...
        LOG.log(Level.FINE, "Retrieved list of schooladmins in the school for the schooladmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername()});
        return src;
    }
    ...
    public static DomSingleSchoolStudent getSingleSchoolStudent(DomGetSingleSchoolStudent submit) throws Dwo2Exception {
        ...
        DomSingleSchoolStudent result = StoredRestManager.getInstance().put("rest/secure/schooladmin/school/getSingleSchoolStudent", DomSingleSchoolStudent.class, rest);
    ...
    public static Boolean updateSingleSchoolStudent(DomSingleSchoolStudent submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/school/updateSingleSchoolStudent", Boolean.class, rest);
    ...
    public static Boolean removeStudentFromSchool(DomStudent submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/school/removeStudent", Boolean.class, rest);
        LOG.log(Level.FINE, "Submitted student {1} for removal from school by user with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), rest.getDomStudent().getId()});
        return result;
    }
    ...
    public static Boolean removeSingleSchoolStudentFromSchool(DomStudent submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/school/removeSingleSchoolStudentFromSchool", Boolean.class, rest);
        LOG.log(Level.FINE, "Submitted student {1} for removal from school by user with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), rest.getDomStudent().getId()});
        return result;
    }
    ...
    public static Boolean removeTeacherFromSchool(DomTeacher submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/school/removeTeacher", Boolean.class, rest);
        LOG.log(Level.FINE, "Submitted student {1} for removal from school by user with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), rest.getDomTeacher().getId()});
        return result;
    }
    ...
    public static Boolean removeSchoolAdminFromSchool(DomSchoolAdmin submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/school/removeSchoolAdmin", Boolean.class, rest);
        LOG.log(Level.FINE, "Submitted student {1} for removal from school by user with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), rest.getDomSchoolAdmin().getId()});
        return result;
    }
    ...
    public static List<DomSchoolClass> GetTeachersSchoolClasses(DomTeacher domTeacher) throws Dwo2Exception {
        ...
        List<DomSchoolClass>  result = StoredRestManager.getInstance().getPutList("rest/secure/schooladmin/school/getTeachersSchoolClassList", RestListClassTypes.DomSchoolClass, rest);
        LOG.log(Level.FINE, "Retrieved {1} schoolclasses of teacher {2} for schooladmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), result.size(), rest.getDomTeacher().getId()});
        return result;
    }
    ...
    public static List<DomSchoolClass> GetStudentsSchoolClasses(DomStudent domStudent) throws Dwo2Exception {
        ...
        List<DomSchoolClass>  result = StoredRestManager.getInstance().getPutList("rest/secure/schooladmin/school/getStudentsSchoolClassList", RestListClassTypes.DomSchoolClass, rest);
        LOG.log(Level.FINE, "Retrieved {1} schoolclasses of student {2} for schooladmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), result.size(), rest.getDomStudent().getId()});
        return result;
    }
    ...
    public static Boolean submitTeacher(DomUserFull submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/school/submitTeacher", Boolean.class, rest);
