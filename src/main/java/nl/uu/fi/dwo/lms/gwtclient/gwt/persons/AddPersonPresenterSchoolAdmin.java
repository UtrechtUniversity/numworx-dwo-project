...
public class AddPersonPresenterSchoolAdmin extends AddPersonPresenter {
  ...
  private final SecuredSchoolAdminSchoolClassManager manager;
  final private LoggingFailure FAILURE;
  private Map<String, TaggedDomSchoolClass> taggedSchoolClasses;

  @Inject AddPersonPresenterSchoolAdmin(DwoGlobalVars dwoGlobalVars, EventBus eventBus) {
    this.eventBus = eventBus;
    this.dwoGlobalVars = dwoGlobalVars;
    this.manager = new SecuredSchoolAdminSchoolClassManager();
  ...
  private void updateSchoolClasses() {
    ...
    promise = manager.getSchoolClasses();
