...
public class SecureSchoolAdminSchoolClassManager {
    ...
    public static List<DomSchoolClass> getSchoolClasses() throws Dwo2Exception {
        ...
        LOG.log(Level.FINE, "Retrieved list of schoolclasses of the schooladmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername()});
        return src;
    }
    ...
    public static List<DomTeacher> getTeachersInSchool() throws Dwo2Exception {
        ...
        LOG.log(Level.FINE, "Retrieved list of teachers in the school for the schooladmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername()});
        return src;
    }
    ...
    public static List<DomStudent> getStudentsInSchool() throws Dwo2Exception {
        ...
        LOG.log(Level.FINE, "Retrieved list of students in the school for the schooladmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername()});
        return src;
    }
    ...
    public static Boolean submitSchoolClass(DomSchoolClassFull schoolClass) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/schoolclass/submit", Boolean.class, rest);
        LOG.log(Level.FINE, "Submitted schoolclass {1} for schooladmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(),schoolClass.getSchoolClassName()});
        return result;
    }
    ...
    public static List<DomTeacher> getTeachersInSchoolClass(DomSchoolClass schoolClass) throws Dwo2Exception {
        ...
        List<DomTeacher> result = StoredRestManager.getInstance().getPutList("rest/secure/schooladmin/schoolclass/getTeacherList", RestListClassTypes.DomTeacher, rest);
        LOG.log(Level.FINE, "Retrieved {1} teachers that are in schoolclass {2} for schooladmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), result.size(), schoolClass.getId()});
        return result;
    }
    ...
    public static List<DomStudent> getStudentsInSchoolClass(DomSchoolClass schoolClass) throws Dwo2Exception {
    	...
    	rest.setRestContext(RestAuthenticator.getInstance().getContext());
        rest.setDomSchoolClass(schoolClass);
        List<DomStudent> result = StoredRestManager.getInstance().getPutList("rest/secure/schooladmin/schoolclass/getStudentList", RestListClassTypes.DomStudent, rest);
        LOG.log(Level.FINE, "Retrieved {1} students that are in schoolclass {2} for schooladmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), result.size(), schoolClass.getId()});
        return result;
    }
    ...
    public static Boolean removeSchoolClass(DomSchoolClass schoolClass) throws Dwo2Exception {
    	...
    	rest.setRestContext(RestAuthenticator.getInstance().getContext());
        rest.setDomSchoolClass(schoolClass);
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/schoolclass/remove", Boolean.class, rest);
        LOG.log(Level.FINE, "Removed schoolclass with username {0} for user with id {1}.", new Object[]{schoolClass.getId(),RestAuthenticator.getInstance().getUsername()});
        return result;
    }
    ...
    public static Boolean submitTeacherToSchoolClass(DomSubmitTeacherToSchoolClass submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/schoolclass/submitTeacher", Boolean.class, rest);
        LOG.log(Level.FINE, "Submitted teacher {1} to schoolclass {2} for schooladmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), submit.getTeacher().getId(), submit.getSchoolClass().getId()});
        return result;
    }
    ...
    public static Boolean submitStudentToSchoolClass(DomSubmitStudentToSchoolClass submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/schoolclass/submitStudent", Boolean.class, rest);
        LOG.log(Level.FINE, "Submitted student {1} to schoolclass {2} for schooladmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), submit.getStudent().getId(), submit.getSchoolClassTo().getId()});
        return result;
    }
    ...
    public static Boolean removeTeacherFromSchoolClass(DomRemoveTeacherFromSchoolClass submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/schoolclass/removeTeacher", Boolean.class, rest);
    ...
    public static Boolean removeStudentFromSchoolClass(DomRemoveStudentFromSchoolClass submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/schoolclass/removeStudent", Boolean.class, rest);
    ...
    public static DomSchoolClassFull getFullSchoolClass(DomSchoolClass schoolClass) throws Dwo2Exception {
    	...
    	rest.setRestContext(RestAuthenticator.getInstance().getContext());
        rest.setDomSchoolClass(schoolClass);
        DomSchoolClassFull result = StoredRestManager.getInstance().put("rest/secure/schooladmin/schoolclass/getFull", DomSchoolClassFull.class, rest);
    ...
    public static Boolean updateSchoolClass(DomSchoolClassFull schoolClass) throws Dwo2Exception {
    	...
    	rest.setRestContext(RestAuthenticator.getInstance().getContext());
        rest.setDomSchoolClassFull(schoolClass);
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/schoolclass/update", Boolean.class, rest);
    ...
    public static Boolean submitSingleSchoolStudent(DomNewSingleSchoolStudent submit) throws Dwo2Exception {
        ...
        Boolean result = StoredRestManager.getInstance().put("rest/secure/schooladmin/schoolclass/submitSingleSchoolStudent", Boolean.class, rest);
        LOG.log(Level.FINE, "Submitted new student with username {1} for schooladmin with username {0}.", new Object[]{RestAuthenticator.getInstance().getUsername(), submit.getDomSingleSchoolStudent().getUserName()});
        return result;
    }
}
