...
public class RolePresenter {
    ...
    private static final Logger LOG = Logger.getLogger(RolePresenter.class.getName());
    ...
    public interface Display {
        ...
        void updateView(Map<String, RolePresenter.SchoolItem> data, RolePresenter.SchoolItem selected);
    }

    public RolePresenter(EventBus anEventBus, DwoGlobalVars aDwoGlobalVars) {
        eventBus = anEventBus;
    ...
    @JsMethod
    public void addRole(String role, String schoolLogin, String schoolCode) {
