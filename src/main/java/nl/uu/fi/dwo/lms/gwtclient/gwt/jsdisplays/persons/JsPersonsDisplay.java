 ...
 * call back: 
 * 
 * public void showTeacherList(); for updating teachers in the table.
 * public void showStudentsList(); for updating students in the table.
 * public void editPerson(String id); user wants to navigate to editPerson en edit the person with given id;
 * public void addPerson(); user wants to navigate to addPerson
 * public void importPersons(); user wants to navigate to importPersons;
 *
