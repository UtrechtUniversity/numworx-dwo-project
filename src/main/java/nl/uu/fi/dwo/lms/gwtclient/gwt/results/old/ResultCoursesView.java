 ...
 */
public class ResultCoursesView {//extends Composite implements ClickHandler, ChangeHandler, CoursesOfSchoolclassPresenter.Display {
//
//    private static final Logger LOG = Logger.getLogger(ResultCoursesView.class.getName());
//
//    interface MyUiBinder extends UiBinder<Widget, ResultCoursesView> {
//    }
...
//                    resultsPresenter.attachItemToSchoolClass((ClassCourseItem) context.getKey());
//                } else {
//                    //detach a classcourse
//                    resultsPresenter.detachItemFromSchoolClass((ClassCourseItem) context.getKey());
//                }
...
//    }
//
//    public ResultCoursesView(ResultsPresenter sp) {
//        resultsPresenter = sp;
...
////        tree = new CellTree(new CoursesOfSchoolclassTreeModel(resultsPresenter), MyTreeCell(resultsPresenter.getTree()));
////        tree = new CellTree(new CoursesOfSchoolclassTreeModel(resultsPresenter), new CourseItem (null,"root"));
//        CourseItem item = new CourseItem(null, "root");
//        //CoursesOfSchoolclassTreeModel model = new CoursesOfSchoolclassTreeModel(resultsPresenter);
//        tree = new Tree();
...
//                        resultsPresenter.setSelectedItem(item);
//                    }
//                }
//            }
//        });
//
//        final ResultCoursesView.MyCell cell = new ResultCoursesView.MyCell();
//        final ResultCoursesView.MyClickCell clickCell = new ResultCoursesView.MyClickCell();
//
//        //name
...
//                resultsPresenter.setCourseType(t.getKey(), value);
...
//            @Override
//            public void update(int index, ClassCourseItem t, String value) {
//                resultsPresenter.setFromDate(t.getKey(), value);
//                dataProvider.refresh();
//            }
//        });
//
...
//            @Override
//            public void update(int index, ClassCourseItem t, String value) {
//                resultsPresenter.setToDate(t.getKey(), value);
//                dataProvider.refresh();
//            }
//        });
//        builder = new SafeHtmlBuilder();
...
//            resultsPresenter.goBackToSchoolClasses();
//        }
//    }
//
//    @Override
...
//        }
//        for (ClassCourseItem child : resultsPresenter.getNodeChildren(item.getKey())) {
...
//        ClassCourseItem item = (ClassCourseItem) treeItem.getUserObject();
//        for (ClassCourseItem i : resultsPresenter.getNodeChildren(item.getKey())) {
//            if (!i.getIsLeaf()) {
...
//            treeItem.setSelected(true);
//            resultsPresenter.setSelectedItem(((ClassCourseItem) treeItem.getUserObject()));
//        }
//
//    }
//
...
////        resultsPresenter.selectItem((ClassCourseItem) dataProvider.getList().get(row), column);
//    }
//
