...
public class SecureUserAccountLoginsManager {
    ...
    public static DomSchoolRoleAndClassV2 switchToSchoolLogin(DomSchoolRoleAndClassV2 src) throws Dwo2Exception {
        ...
        DomSchoolRoleAndClassV2 result = StoredRestManager.getInstance().put("rest/secure/user/account/loginsV2/select", DomSchoolRoleAndClassV2.class, rest);
        return result;
    }
    ...
    public static boolean addASchoolLogin(DomNewSchoolLogin newSchoolLogin) throws Dwo2Exception {
        ...
        r = StoredRestManager.getInstance().put("rest/secure/user/account/loginsV2/submit", Boolean.class, rest);
    ...
    public static boolean removeASchoolLogin(DomSchoolRoleAndClassV2 toRemoveSchoolLogin) throws Dwo2Exception {
        ...
        boolean r;
        r = StoredRestManager.getInstance().put("rest/secure/user/account/loginsV2/remove", Boolean.class, rest);
