 ...
 * available as a JavaScript object named "JsProgressDialogDisplay".
 ...
 */
@JsType(isNative = true, name = "JsProgressDialogDisplay", namespace = JsPackage.GLOBAL)
//@JsType(isNative = false, namespace = JsPackage.GLOBAL)
public class JsProgressDialogDisplay{
