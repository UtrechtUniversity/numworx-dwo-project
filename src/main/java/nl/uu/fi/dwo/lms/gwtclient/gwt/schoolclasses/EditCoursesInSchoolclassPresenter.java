...
//                Map<String, EditCoursesInSchoolclassPresenter.CourseItem> oldStudentItems = studentItems;
...
//    }
     ...
     * @param op
     */
    public void selectItem(EditCoursesInSchoolclassPresenter.CourseItem item, int op) {
        switch (op) {
            case 4:
   ...
   eventBus.fireEvent (new SwitchViewEvent(SwitchViewEvent.SelectedView.SCHOOLCLASSES));
    ...
    public void addSelectedToSchoolClass(String classKey) {
        ...
        final int cnt;
        int tmp = 0;
        for (CourseItem item : studentItems.values()) {
            if (item.selected) {
                tmp++;
            }
        }
