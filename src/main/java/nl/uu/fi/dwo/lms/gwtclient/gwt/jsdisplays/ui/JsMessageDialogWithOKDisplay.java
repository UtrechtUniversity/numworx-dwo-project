...
/**
 * JsMessageDialogWithOKDisplay UI interface. the interface should be
 * available as a JavaScript object named "JsMessageDialogWithOKDisplay".
...
public class JsMessageDialogWithOKDisplay{
