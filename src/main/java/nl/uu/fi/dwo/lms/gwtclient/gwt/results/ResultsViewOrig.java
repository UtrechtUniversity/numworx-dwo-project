 ...
 */
public class ResultsViewOrig extends Composite implements ResultsPresenter.Display{

    private static final Logger LOG = Logger.getLogger(ResultsViewOrig.class.getName());

    interface MyUiBinder extends UiBinder<Widget, ResultsViewOrig> {
    }
...
//    }
    ...
    public ResultsViewOrig(ResultsPresenter rp) {
        resultsPresenter = rp;
        rp.setView(this);
