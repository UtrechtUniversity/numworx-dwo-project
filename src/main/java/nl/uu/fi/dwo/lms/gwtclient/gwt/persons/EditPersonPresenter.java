...
public class EditPersonPresenter {
    ...
    private static final Logger LOG = Logger.getLogger(EditPersonPresenter.class.getName());
...
//        void setSchoolClass(DomSchoolClassFull schoolClass);
    ...
    public EditPersonPresenter(EventBus anEventBus, DwoGlobalVars aDwoGlobalVars) {
        eventBus = anEventBus;
