...
public class CheckBox extends ButtonBase implements HasName, HasValue<Boolean>,
  ...
  LabelElement labelElem, markerElem;
  ...
  protected CheckBox(Element elem) {
    ...
    markerElem = Document.get().createLabelElement();
    Element div = DOM.createDiv();
    div.addClassName("checkbox");
    getElement().appendChild(div);
    div.appendChild(inputElem);
    div.appendChild(markerElem);
    getElement().appendChild(labelElem);

    String uid = DOM.createUniqueId();
    inputElem.setPropertyString("id", uid);
    labelElem.setHtmlFor(uid);
    markerElem.setHtmlFor(uid);
    markerElem.addClassName("icon");
