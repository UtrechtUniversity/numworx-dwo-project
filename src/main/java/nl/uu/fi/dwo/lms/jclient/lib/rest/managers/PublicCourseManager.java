...
public class PublicCourseManager {
    ...
    /**
     * get public toplevel courses from a profile. Security: if profile is
     * limited, only members of some schools are allowed.
     *
     * @param profile
    ...
    public static List<DomCourseStudent> getCourses(DomDwoProfile profile) throws Dwo2Exception {
        ...
        List<DomCourseStudent> result = StoredRestManager.getInstance().getPutList("rest/public/course/getRoot", RestListClassTypes.DomCourseStudent, rest);
    ...
    /**
     * get a course. Security: profile can be limited. The course can be an
     * assessment. Wrong profile, Wrong school
     *
     * @param course
     * @param profile
     * @return a course
    ...
    public static DomCourseStudent getCourse(DomCourse course, DomDwoProfile profile) throws Dwo2Exception {
        ...
        DomCourseStudent result = StoredRestManager.getInstance().put("rest/public/course/get", DomCourseStudent.class, rest);
        return result;
    }

    /**
     * get children of a course. The course must have children. Security:
     * profile can be limited, The course can be an assessment. Wrong profile,
     * Wrong school
     *
     * @param course
     * @param profile
    ...
    public static List<DomCourseStudent> getCourses(DomCourse course, DomDwoProfile profile) throws Dwo2Exception {
        ...
        rest.setDomCourse(course);
    	rest.setRestContext(RestAuthenticator.getInstance().getContext());
        List<DomCourseStudent> result = StoredRestManager.getInstance().getPutList("rest/public/course/getChildren", RestListClassTypes.DomCourseStudent, rest);
