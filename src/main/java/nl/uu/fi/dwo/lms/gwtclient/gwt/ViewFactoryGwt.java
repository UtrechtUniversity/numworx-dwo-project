 ...
 */
public class ViewFactoryGwt implements ViewFactory {

    private final MainView mainViewAsWidget;
    ...
    public ViewFactoryGwt(PresenterFactory pf) {
        mainViewAsWidget = new MainView(pf.getMainPresenter());
