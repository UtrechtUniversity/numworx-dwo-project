 ...
 */
public class ResultsFileExportPresenter implements SchoolClassDialogEventHandler {

    private static final Logger LOG = Logger.getLogger(ResultsFileExportPresenter.class.getName());
    ...
    public ResultsFileExportPresenter(EventBus anEventBus, DwoGlobalVars aDwoGlobalVars) {
        eventBus = anEventBus;
