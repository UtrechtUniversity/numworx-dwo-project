	...
	public static int[][] getLocData(String teken) {
		...
		if("h".equals(teken)) {
			int[][] data = {
					{ 0, 100, 0, 20, 0, 0, 1},
					{ 0, 100, 30, 100, 10, 39, 27},
					{ 50, 100, 80, 100, 39, 39, 1},
			};
			return data;
		}
		if("h_1".equals(teken)) {
			int[][] data = {
					{ 80, 100, 80, 100, 39, 39, 1},
					{0, 60, 30, 100, 0, 0, 1},
		...
		if("m".equals(teken)) {
			int[][] data = {
					{ 0, 50, 70, 100, 5, 15, 1},
					{ 25, 75, 50, 100, 20, 25, 1},
					{ 50, 100, 70, 100, 34, 39, 1},
			};
			return data;
		}
		if("n".equals(teken)) {
			int[][] data = {
					{ 50, 100, 0, 100, 25, 39, 8},
					{ 0, 50, 70, 100, 5, 18, 1},
			};
			return data;
		}
		...
		if("D".equals(teken)) {
			int[][] data = {
					{  0, 100, 80, 100, 30, 39, 5},
					{  0, 100, 0, 20, 14, 27, 5},
					{  80, 100, 0, 100, 24, 33, 5}
			};
			return data;
		}
		if("R".equals(teken)) {
		...
		if("of_1".equals(teken)) {
			int[][] data = {
					{ 0, 100, 20, 80, 0, 10, 8},
					{ 50, 100, 30, 70, 39, 39, 1},
		...
		if("G".equals(teken)) {
			int[][] data = {
					{  60, 100, 40, 80, 39, 39, 1},
					{  0, 29, 0, 100, 10, 25, 10},
					{  1, 100, 80, 100, 20, 30, 5},
					{  1, 100, 90, 100, 20, 30, 5}
			};
			return data;
		}
		if("B".equals(teken)) {
		...
		if("M".equals(teken)) {
			int[][] data = {
					{  0, 50, 0, 20, 8, 20, 2},
					{  50, 100, 0, 20, 20, 30, 2},
					{  30, 70, 30, 100, 15, 25, 1},
					{  0, 20, 70, 100, 0, 0, 1},
					{  80, 100, 70, 100, 39, 39, 1}
