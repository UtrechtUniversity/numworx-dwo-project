...
public class StrokeDAngleFilter {
	...
	public static int[][] getDAngleData(String teken) {
		...
		if("2".equals(teken)) {int[][] data = {{-300,-70,-80,20,2,17}};return data;}
		...
		if("9".equals(teken)) {int[][] data = {};return data;}
		...
		if("x".equals(teken)) {int[][] data = {{-300,-20,-120,5,2,10}};return data;}
