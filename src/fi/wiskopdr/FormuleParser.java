...
public class FormuleParser
{
		...
		try
		{
			...
			for (int j = 0; j < vergelijkingStrings.length; j++)
			{
				...
				if (index1 > -1 && index2 > index1)
				{
					...
					//StringUtils.split(vergelijkingStrings[j].substring(index1+1,index2),":");
			...
			for (int i = 0; i < vergelijkingStrings.length; i++)
			{
				...
				for (int j = 0; j < vergTekens.length && !split && vergelijkingen[i] == null; j++)
				{
					...
					{ //if(expressieStrings[1].trim().equals(WiskOpdr.rb.getString("antwoordModelGeen"))) expressieStrings[1] = "0.1234567";
						if (expressieStrings[1].trim().equals("geen") || expressieStrings[1].trim().equals("none"))
							expressieStrings[1] = "0.1234567";
						if (expressieStrings[1].trim().equals("alles") || expressieStrings[1].trim().equals("all"))
							expressieStrings[1] = "0.7654321";
						Expressie e1 = null;
						Expressie e2 = null;
		...
		while (ind > -1)
		{
			...
			for (int i = 0; i < s2.length(); i++)
			{
				if (s2.charAt(i) == ')')
					...
					niv--;
				else if (s2.charAt(i) == ',' && niv == 0)
					s2 = s2.substring(0, i) + "_" + s2.substring(i + 1);
				if (niv > 0)
					break;
			}
			s = s1 + s2;
	...
	public static String schoon(String s, boolean woordformule)
	{
		...
		while (index > -1)
		{
			...
			else if (index > -1 && index + 2 < s.length())
				s = s.substring(0, index) + "(-1)" + s.substring(index + 2);
		}
		...
		while (index > -1)
		{
			...
			if (s.charAt(telmin) == '(' && s.charAt(telmin - 1) == '(' && Character.isDigit(s.charAt(telmin - 2)) && s.charAt(telmax) == ')' && s.charAt(telmax + 1) == ')')
			{
		...
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "sqrt" + s.substring(index + 8);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "rnd" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "rns" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "sgf" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "rnq" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "abs" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "conjug" + s.substring(index + 12);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "binomcdf" + s.substring(index + 16);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "binompdf" + s.substring(index + 16);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "poissoncdf" + s.substring(index + 20);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "poissonpdf" + s.substring(index + 20);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "bin" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "difpar" + s.substring(index + 12);
		}
		...
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "dif" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "prm" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "sig" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "lim" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "int" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "gcd" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "min" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "max" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "normalcdf" + s.substring(index + 18);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "invNorm" + s.substring(index + 14);
		}
		index = 0;
		while (index > -1)
		{
		...
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "prv" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "arcsin" + s.substring(index + 12);
		}
		index = 0;
		while (index > -1)
		{
			index = s.indexOf("a*r*c*s*i*n");
			if (index > -1)
				s = s.substring(0, index) + "arcsin" + s.substring(index + 11);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "arccos" + s.substring(index + 12);
		}
		index = 0;
		while (index > -1)
		{
			index = s.indexOf("a*r*c*c*o*s");
			if (index > -1)
				s = s.substring(0, index) + "arccos" + s.substring(index + 11);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "arctan" + s.substring(index + 12);
		}
		index = 0;
		while (index > -1)
		{
			index = s.indexOf("a*r*c*t*a*n");
			if (index > -1)
				s = s.substring(0, index) + "arctan" + s.substring(index + 11);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "sin" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			index = s.indexOf("s*i*n");
			if (index > -1)
				s = s.substring(0, index) + "sin" + s.substring(index + 5);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "cos" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			index = s.indexOf("c*o*s");
			if (index > -1)
				s = s.substring(0, index) + "cos" + s.substring(index + 5);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "tan" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			index = s.indexOf("t*a*n");
			if (index > -1)
				s = s.substring(0, index) + "tan" + s.substring(index + 5);
		}
		index = 0;
		while (index > -1)
		{
			...
			if (index > -1)
				s = s.substring(0, index) + "log" + s.substring(index + 6);
		}
		index = 0;
		while (index > -1)
		{
			index = s.indexOf("l*o*g");
			if (index > -1)
				s = s.substring(0, index) + "log" + s.substring(index + 5);
		}
		index = 0;
		while (index > -1)
		{
			index = s.indexOf("l*n*");
			if (index > -1)
				s = s.substring(0, index) + "ln" + s.substring(index + 4);
		}
		index = 0;
		while (index > -1)
		{
