...
public class Algebra
{
	...
	public static void setAbsPrecision(double d)
	{
		if (d < 0.000000001)
			...
			absPrecision = d + 0.0000000000001;
	}
	...
	public static boolean isGelijkwaardig(Expressie e1, Expressie e2)
	{
		...
		double[] tryIntValues =
		{ tryValuesStart + 0.101 * tryValuesWidthfactor, tryValuesStart + 1.102 * tryValuesWidthfactor, tryValuesStart + 2.103 * tryValuesWidthfactor, tryValuesStart + 3.104 * tryValuesWidthfactor, tryValuesStart + 4.105 * tryValuesWidthfactor };
		double[] tryIntValuesBeperkt =
		{ tryValuesStart + 0.101 * tryValuesWidthfactor, tryValuesStart + 2.102 * tryValuesWidthfactor, tryValuesStart + 4.103 * tryValuesWidthfactor };
		if (vars.length > 3)
	...
	public static boolean gelijkGevormd(Vergelijking v1, Vergelijking v2)
	{
		if (v1 == null || v2 == null)
			return false;
		return (gelijkGevormd(v1.kind1, v2.kind1) && gelijkGevormd(v1.kind2, v2.kind2) && v1.geefVergTeken().equals(v2.geefVergTeken()) || gelijkGevormd(v1.kind1, v2.kind2) && gelijkGevormd(v1.kind2, v2.kind1) && v1.geefVergTeken().equals(Vergelijking.geefInvVergTeken(v2.geefVergTeken())));
	}
	...
	public static boolean gelijkGevormd(VergelijkingMeerv vm1, VergelijkingMeerv vm2)
	{
		if (vm1 == null || vm2 == null)
			return false;
		if (vm1.vergelijkingen.length != vm2.vergelijkingen.length)
			return false;
		...
		*/
		...
		else
		{
			for (int i = 0; i < vm1.vergelijkingen.length; i++)
			{
				if (!gelijkGevormd(vm1.vergelijkingen[i], vm2.vergelijkingen[i]))
					return false;
			}
			return true;
		}
	...
	public static boolean zijnGelijk(Expressie e1, Expressie e2, boolean vorm)
	{
		...
		if (vorm && e2 instanceof BasisExpressie && e2.toString().equals("G") && !Double.isNaN(e1.geefWaarde()))
			return true;
		...
		if (v1.size() == 1 && v2.size() == 1)
		{
			...
			if (v1.size() == 1 && v2.size() == 1)
			{
				...
				if ((isBreukPlusGetal(e1) || isBreukPlusGetal(e2)) && !e1.toStringStrikt().equals(e2.toStringStrikt()))
					return false;
				else if (e1.toStringStrikt().length() > 0 && e2.toStringStrikt().length() > 0 && !e1.toStringStrikt().substring(0, 1).equals(e2.toStringStrikt().substring(0, 1)))
					return false;
				else if (e1.toStringStrikt().length() > 1 && e2.toStringStrikt().length() > 1 && !e1.toStringStrikt().substring(0, 2).equals(e2.toStringStrikt().substring(0, 2)))
					return false;
				else if (e1.toStringStrikt().length() > 3 && e2.toStringStrikt().length() > 3 && e1.toStringStrikt().substring(0, 3).equals("arc") && !e1.toStringStrikt().substring(0, 4).equals(e2.toStringStrikt().substring(0, 4)))
					return false;
	...
	public static boolean isGelijkwaardigeLinVergelijking(Expressie eLinks1, Expressie eRechts1, Expressie eLinks2, Expressie eRechts2)
	{
		...
		if (Math.abs(e1.geefWaarde(0)) < 0.000000001 && Math.abs(e2.geefWaarde(0)) < 0.000000001 || Math.abs(e1.geefWaarde(1)) < 0.000000001 && Math.abs(e2.geefWaarde(1)) < 0.000000001)
			return true;
		double factorA = e1.geefWaarde(0) / e2.geefWaarde(0);
		double factorB = e1.geefWaarde(1) / e2.geefWaarde(1);
		if (Math.abs(factorA - factorB) > 0.000000001)
			return false;
		return true;
	}
	...
	public static boolean heeftOplossingen(Expressie e1, Expressie e2)
	{
		...
		if (coeff.length == 3 && coeff[1] * coeff[1] - 4 * coeff[0] * coeff[2] < 0)
			return false;
		return true;
	}
	...
	{
		if ((e instanceof Optelling || e instanceof Aftrekking) && !(e instanceof Optelling && e.kind1 instanceof BasisExpressie && !Double.isNaN(e.kind1.geefWaarde()) && e.kind2 instanceof Deling && e.kind2.kind1 instanceof BasisExpressie && !Double.isNaN(e.kind2.kind1.geefWaarde()) && e.kind2.kind2 instanceof BasisExpressie && !Double.isNaN(e.kind2.kind2.geefWaarde())))
		{
			if (e instanceof Optelling && (e.kind2 instanceof Optelling || e.kind2 instanceof Aftrekking))
			{
		...
		{
			if (!(e instanceof BasisExpressie && e.geefWaarde() == 0))
	...
	public static int geefAantalOperatoren(Expressie e)
	{
		int aantal = 0;
		if (e.kind1 != null)
			aantal += geefAantalOperatoren(e.kind1);
		if (e.kind2 != null)
			aantal += geefAantalOperatoren(e.kind2);
		if (e.kind1 != null || e.kind2 != null)
			aantal++;
		return aantal;
	}
	...
	public static int geefAantalBreukPlusGetal(Expressie e)
	{
		int aantal = 0;
		if (e.kind1 != null)
			aantal += geefAantalBreukPlusGetal(e.kind1);
		if (e.kind2 != null)
			aantal += geefAantalBreukPlusGetal(e.kind2);
		if (e instanceof Optelling && e.kind1 instanceof BasisExpressie && !Double.isNaN(e.kind1.geefWaarde()) && e.kind2 instanceof Deling && e.kind2.kind1 instanceof BasisExpressie && !Double.isNaN(e.kind2.kind1.geefWaarde()) && e.kind2.kind2 instanceof BasisExpressie && !Double.isNaN(e.kind2.kind2.geefWaarde()))
			aantal++;
		return aantal;
	}
	...
	{
		if (e instanceof Macht)
			v.addElement(e);
		if (e.kind1 != null)
			Algebra.geefMachten(e.kind1, v);
		if (e.kind2 != null)
			Algebra.geefMachten(e.kind2, v);
		return v;
	}
	...
	public static Vector geefLogExpressies(Expressie e, Vector v)
	{
		if (e instanceof Log)
			v.addElement(e);
		if (e.kind1 != null)
			Algebra.geefLogExpressies(e.kind1, v);
		if (e.kind2 != null)
			Algebra.geefLogExpressies(e.kind2, v);
		return v;
	}

	public static Vector geefDelingen(Expressie e, Vector v)
	{
		if (e instanceof Deling)
			v.addElement(e);
		if (e.kind1 != null)
			Algebra.geefDelingen(e.kind1, v);
		if (e.kind2 != null)
			Algebra.geefDelingen(e.kind2, v);
		return v;
	}

	public static Vector geefAftrekkingen(Expressie e, Vector v)
	{
		if (e instanceof Aftrekking)
			v.addElement(e);
		if (e.kind1 != null)
			Algebra.geefAftrekkingen(e.kind1, v);
		if (e.kind2 != null)
			Algebra.geefAftrekkingen(e.kind2, v);
		return v;
	}

	public static Vector geefWortels(Expressie e, Vector v)
	{
		if (e instanceof Wortel || e instanceof NdeWortel)
			v.addElement(e);
		if (e.kind1 != null)
			Algebra.geefWortels(e.kind1, v);
		if (e.kind2 != null)
			Algebra.geefWortels(e.kind2, v);
		return v;
	}
	...
	public static boolean isBreukPlusGetal(Expressie e)
	{
		...
		{
			if (e.kind2 instanceof Optelling && e.kind2.kind1 instanceof BasisExpressie && !Double.isNaN(e.kind2.kind1.geefWaarde()) && e.kind2.kind2 instanceof Deling && e.kind2.kind2.kind1 instanceof BasisExpressie && !Double.isNaN(e.kind2.kind2.kind1.geefWaarde()) && e.kind2.kind2.kind2 instanceof BasisExpressie && !Double.isNaN(e.kind2.kind2.kind2.geefWaarde()))
			{
				return true;
			}
			else
	...
	public static int geefAantalMachten(Expressie e)
	{
		int aantal = 0;
		if (e.kind1 != null)
			aantal += geefAantalMachten(e.kind1);
		if (e.kind2 != null)
			aantal += geefAantalMachten(e.kind2);
		if (e instanceof Macht)
			aantal++;
		return aantal;
	}
	...
	public static Expressie maakFactorenExpressie(Vector v)
	{
		...
		{
			Expressie ee = (Expressie) v.elementAt(i);
			if ((ee instanceof BasisExpressie && Double.isNaN(ee.geefWaarde())) || (ee instanceof Deling && ee.kind1.geefWaarde() == 1 && ee.kind2 instanceof BasisExpressie && Double.isNaN(ee.kind2.geefWaarde())))
			{
				String varnaam;
				int aantalF;
				Expressie basisE;
		...
		for (int i = v.size() - 1; i > -1; i--)
		{
			...
			if (ee.geefWaarde() != 1 && !(ee instanceof Deling))
			{
				if (expTeller == null)
					...
					expTeller = new Vermenigvuldiging(expTeller, ee);
			}
			else if (ee.geefWaarde() != 1 && ee instanceof Deling)
			{
				if (expNoemer == null)
					...
					expNoemer = new Vermenigvuldiging(expNoemer, ee.kind2);
			}
		}
		...
		else if (eGetal.geefWaarde() == 1)
		{
			if (expNoemer == null)
				exp = expTeller;
			else if (expTeller == null)
				exp = new Deling(new BasisExpressie(1), expNoemer);
			else
				exp = new Deling(expTeller, expNoemer);
		}
		else if (eGetal.geefWaarde() == -1)
		{
			if (expNoemer == null)
				exp = new Aftrekking(new BasisExpressie(0), expTeller);
			else if (expTeller == null)
				exp = new Aftrekking(new BasisExpressie(0), new Deling(new BasisExpressie(1), expNoemer));
			else
				exp = new Aftrekking(new BasisExpressie(0), new Deling(expTeller, expNoemer));
		}
		else if (eGetal instanceof Aftrekking && eGetal.kind1.geefWaarde() == 0)
		{
			...
			if (expNoemer == null)
				exp = new Aftrekking(new BasisExpressie(0), new Vermenigvuldiging(eGetal.kind2, expTeller));
			else if (expTeller == null && noemerGetal.geefWaarde() == 1)
				exp = new Aftrekking(new BasisExpressie(0), new Deling(tellerGetal, expNoemer));
			else if (expTeller == null)
				exp = new Aftrekking(new BasisExpressie(0), new Deling(tellerGetal, new Vermenigvuldiging(noemerGetal, expNoemer)));
			else if (tellerGetal.geefWaarde() == 1)
				exp = new Aftrekking(new BasisExpressie(0), new Deling(expTeller, new Vermenigvuldiging(noemerGetal, expNoemer)));
			else if (noemerGetal.geefWaarde() == 1)
				exp = new Aftrekking(new BasisExpressie(0), new Deling(new Vermenigvuldiging(tellerGetal, expTeller), expNoemer));
			else
				exp = new Aftrekking(new BasisExpressie(0), new Deling(new Vermenigvuldiging(tellerGetal, expTeller), new Vermenigvuldiging(noemerGetal, expNoemer)));
		}
		...
		else
		{
			...
			if (expNoemer == null)
				exp = new Vermenigvuldiging(eGetal, expTeller);
			else if (expTeller == null && noemerGetal.geefWaarde() == 1)
				exp = new Deling(tellerGetal, expNoemer);
			else if (expTeller == null)
				exp = new Deling(tellerGetal, new Vermenigvuldiging(noemerGetal, expNoemer));
			else if (tellerGetal.geefWaarde() == 1)
				exp = new Deling(expTeller, new Vermenigvuldiging(noemerGetal, expNoemer));
			else if (noemerGetal.geefWaarde() == 1)
				exp = new Deling(new Vermenigvuldiging(tellerGetal, expTeller), expNoemer);
			else
				exp = new Deling(new Vermenigvuldiging(tellerGetal, expTeller), new Vermenigvuldiging(noemerGetal, expNoemer));
		}
	...
	public static boolean expanded(Expressie e)
	{
		...
		for (int i = 0; i < v.size(); i++)
		{
			...
			for (int j = 0; j < u.size(); j++)
			{
				...
				if (Double.isNaN(eee.geefWaarde()) && !(eee instanceof BasisExpressie))
				{
					return false;
				}
			}
	...
	public static Expressie geefWortel(Expressie e)
	{
		...
		if (wortelGetal instanceof Wortel)
			isKwadraat = false;
		for (int i = 0; i < varNamen.length; i++)
		{
			if (exponenten[i] % 2 == 1)
	...
	public static Expressie benaderWortels(Expressie e)
	{
		...
		else if (!(e instanceof BasisExpressie))
		{
			...
			if (e.kind2 != null)
				e.kind2 = benaderWortels(e.kind2);
		}
		return e;
	}
	...
	public static Expressie evalueerGetalsExpressie(Expressie exp, boolean breukenGemengd)
	{
		...
		if (exp instanceof DecRoundStrict)
		{
			if (exp.kind2.geefWaarde() > 0.000000001)
			{
				...
				NumberFormat df = NumberFormat.getFormat(formatString);
		...
		if (p == null)
		{
			if (exp.isWaarde() && !withinLongRange((long) exp.geefWaarde()))
				return new BasisExpressie(exp.geefWaarde());
			return exp;
		}
		...
		else if (teller < 0 && (long) Math.abs(teller) > (long) Math.abs(noemer))
		{
			...
			if (delen == 0)
				exp = new Aftrekking(new BasisExpressie(0), new BasisExpressie(helen));
		}
		else if (teller == 0)
		{
