...
public class DbAccessLocal extends DbAccess {
    ...
    public Connection getConnection() throws SQLException {
        ...
        if (!DWO.getDbConnectStringProperty().matches("")) {
            c = DriverManager.getConnection(DWO.getDbConnectStringProperty());
            //System.err.println("Using property defined connection.");
        }
        return c;
    }
