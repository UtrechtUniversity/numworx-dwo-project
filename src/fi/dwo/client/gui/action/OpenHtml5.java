...
public class OpenHtml5 extends GuiAction {
	...
	static class WrapSco extends Sco {
		/**
		 * @param delegate
		 */
		 ...
		 * @param propertyName
		 * @param listener
		 * @see fi.dwo.client.domain.Sco#addPropertyChangeListener(java.lang.String, java.beans.PropertyChangeListener)
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.ScoBase#getID()
		 */
		public int getID() {
		...
		/**
		 * @param listener
		 * @see fi.dwo.client.domain.Sco#removePropertyChangeListener(java.beans.PropertyChangeListener)
		 */
		 ...
		 * @param propertyName
		 * @param listener
		 * @see fi.dwo.client.domain.Sco#removePropertyChangeListener(java.lang.String, java.beans.PropertyChangeListener)
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#isShowScore()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getShowScore()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getPartialScoreIF()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.ScoBase#LMSGetLastError()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getName()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getScoName()
		 */
		...
		public String LMSInitialize(String iParam) {
			...
			return super.LMSInitialize(iParam);
		}

		/**
		 * @return
		 * @see fi.dwo.client.domain.ScoBase#isDataChanged()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.ScoBase#getScoID()
		 */
		public int getScoID() {
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.ScoBase#getAppletData()
		 */
		 ...
		 * @param iValue
		 * @return
		 * @see fi.dwo.client.domain.ScoBase#SetValue(java.lang.String, java.lang.String)
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getAppletID()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getDescription()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.ScoBase#getUser()
		 */
		public User getUser() {
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.ScoBase#getLaunchdata()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.ScoBase#getLaunchdataString()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.ScoBase#getLaunchdataBytes()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getAppletContext()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getCodeBase()
		 */
		...
		public void setLaunchdataString(String ld) {
			delegate.setLaunchdataString(ld);
		}

		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getDocumentBase()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.ScoBase#getCourse()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getTitle()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getParentTitle()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getChildTitle()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getOrderAscTitle()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getOrderDescTitle()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getSequencenr()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#getToolTip()
		 */
		 ...
		 * @param str
		 * @return
		 * @see fi.beans.scorm.ScormAdapter#from2004Time(java.lang.String)
		 */
		public long from2004Time(String str) {
			return delegate.from2004Time(str);
		}
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.ScoBase#isCourseChanged()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#isActive()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#isDeepestLevel()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#isHighestLevel()
		 */
		...
		/**
		 * @return
		 * @see fi.dwo.client.domain.Sco#toString()
		 */
