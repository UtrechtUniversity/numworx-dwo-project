...
public class SaveAppletAction extends GuiAction {
	...
	{	Hashtable launchData;
		...
		try {	
			...
			if(sco.getCourse().getDwoProfile()==13 || sco.getCourse().getDwoProfile()==57 || sco.getCourse().getDwoProfile()==65)htmlSource = new URL("http://www.fisme.science.uu.nl/dwo/scorm/applet/appletGR.htm");
