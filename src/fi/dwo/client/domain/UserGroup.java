 ...
 * It must be implemented by classes that represents a UserGroup (e.g. SchoolClass, User)<br>
 * 
 * @author M.J.B. Kupers
 *  
 */
public interface UserGroup {
    ...
    /**
     * Returns a typename representing the UserGroup. For example for the user object,
     * it returns the string 'Student'.
