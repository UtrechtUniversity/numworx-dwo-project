...
import fi.dwo.client.gui.ResultScoreButton;
...
public class ResultScore implements ResultScoreIF {
    ...
    /**
     * Returns the score for the lessongroup and the usergroup.
     * If corrtotaal is zero, the result is also zero instead of Infinity/NaN.
     * 
    ...
    /**
     * Zet het gecorrigeerde totaal. Dat is het totaal aantal elementen waar de score op betrekking heeft.
     * @param correctie
     */
