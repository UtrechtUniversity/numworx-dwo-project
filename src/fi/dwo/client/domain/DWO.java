 ...
 *
 * For testing purposes there is the option for a property file in the local
 * startup directory named <code>DWO.properties</code> It allows to set a
 * specific database connections for testing purposes:
 * <p><p>
 * <code>connectMode</code> Either <code>Servlet</code> or <code>Local</code>
 * <code>dbConnectString </code> Used by dbAccessLocal mode. For example: 
 * jdbc:mysql://localhost/fisme_dwo?user=root&password=secret<p>
 * <code>servletConnectString</code> the url for the servlet connection<p>
 */
public class DWO extends JApplet implements SCORM12APIInterface, DwoIF {
    ...
    private static String connectModeProperty = "Local";
    private static String servletConnectStringProperty = "http://localhost/dwo/servlet";
     ...
     */
    public static String getConnectModeProperty() {
        return connectModeProperty;
    }

    /**
     * @return the servletConnectStringProperty
     */
    public static String getServletConnectStringProperty() {
        return servletConnectStringProperty;
    }
    ...
    private static void ReadConfigProperties() {
        ...
        try {
            ...
            log.log(Level.FINER, "Property {0} is value: {1}", new Object[]{"connectMode", getDbConnectStringProperty()});
            ...
            servletConnectStringProperty = properties.getProperty("servletConnectString");
            log.log(Level.FINER, "Property {0} is value: {1}", new Object[]{"servletConnectString", getServletConnectStringProperty()});
