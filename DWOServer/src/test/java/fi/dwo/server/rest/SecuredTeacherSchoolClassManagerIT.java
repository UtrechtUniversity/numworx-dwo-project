...
public class SecuredTeacherSchoolClassManagerIT {
     ...
     */
    @Test
    public void testGetTeachersSchoolClasses1() {
    ...
    public void testGetTeachersSchoolClasses2() throws Dwo2Exception {
		...
		List<DomSchoolClass> result = instance.getTeachersSchoolClasses(sc, rest);
        assertEquals(1, result.size());
    }
...
//    }
    ...
    public void testUpdateSingleSchoolStudent() {
        ...
        dssStudent.setId(PersistentUser.buildPersistenceId(10L));  // update by PersistenceID, not by name!
        dssStudent.setGivenName("User");
...
//        PersistenceId id = MySQLPersistenceId.createPersistenceId(2, PersistenceClassType.PersistentSchoolClass);
    ...
    @Test
    public void testSubmitSingleSchoolStudent_expire() throws Exception {
