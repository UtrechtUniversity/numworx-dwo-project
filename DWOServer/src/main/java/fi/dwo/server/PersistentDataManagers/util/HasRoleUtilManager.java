...
public class HasRoleUtilManager {
    ...
    public static PersistentHasRole getCurrentHasRole(String usercode, RoleType r) throws Dwo2Exception {
        ...
        int roleId = 0;
        try {
            roleId = hr.getSchoolGroup().getGroupID();
        } catch (Exception e) {
    ...
    public static PersistentSchool getSchoolforHasRole(PersistentHasRole hr) throws Dwo2Exception {
        ...
        if (sg == null||sg.getSchool() == null)		
        	sg = SchoolGroupManager.findEntity(hr.getPersistentHasRolePK().getSchoolGroupID());
        if (sg == null) {
 ...
 */
    ...
    public static Boolean removeHasRoleAndItsData(PersistentHasRole hr) throws Dwo2Exception {
        ...
        List<PersistentStudentModelData> smdList = StudentModelDataManager.findEntities(hr);
        smdList.forEach(t -> StudentModelDataManager.destroy(t.getModelDataId()));
