 ...
 */
@XmlRootElement
public class DomResultsPerTeacherv2 {
    ...
    private List<DomClassCourse4Teacher> classCourses;
    private List<DomCourse> courses;
    private List<DomScoContext> scoContexts;
    private List<DomStudentScoContext> studentScoContexts;
    private List<DomStudentScoPage> studentScoPages;
     ...
     */
    public void setStudents(List<DomStudent> aStudents) {
     ...
     */
    public void setSchoolClasses(List<DomSchoolClass> aSchoolClasses) {
     ...
     */
    public void setScoContexts(List<DomScoContext> aScoContexts) {
     ...
     */
    public List<DomStudentScoContext> getStudentScoContexts() {
     ...
     */
    public void setStudentScoContexts(List<DomStudentScoContext> aStudentScoContexts) {
     ...
     */
    public void setCourses(List<DomCourse> aCourses) {
     ...
     */
    public List<DomClassCourse4Teacher> getClassCourses() {
        return classCourses;
    }
     ...
     */
    public void setClassCourses(List<DomClassCourse4Teacher> aClassCourses) {
     ...
     */
    public void setStudentsOfClasses(List<DomStudentOfClass> aStudentsOfClasses) {
        this.studentsOfClasses = aStudentsOfClasses;
    }

	public List<DomStudentScoPage> getStudentScoPages() {
		return studentScoPages;
	}

	public void setStudentScoPages(List<DomStudentScoPage> studentScoPages) {
