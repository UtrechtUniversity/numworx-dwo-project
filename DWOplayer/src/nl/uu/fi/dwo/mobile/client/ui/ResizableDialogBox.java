 ...
 * functionality. By default, the ResizableDialogBox has two control-buttons in the top
 ...
 * controls can be toggled separately with
 * {@link #setMinimizeIconVisible(boolean)} and
 * {@link #setCloseIconVisible(boolean)} respectively. <br>
 * <br>
 * The ResizableDialogBox relies on the css settings of {@link DialogBox} for styling of
 ...
 * </pre>
 * 
 * Please note: deze css wordt nu niet gebruikt. Bewaard voor de toekomst.
 */
public class ResizableDialogBox extends DialogBox implements HasOpenHandlers<ResizableDialogBox>
{
	 ...
	 * 
	 * @see ResizableDialogBox#DialogBoxEx(boolean, boolean, boolean, boolean)
	 */
	 ...
	 *            <code>true</code> to allow resizing by dragging the borders
	 */
	public ResizableDialogBox(boolean autoHide, boolean modal, boolean showMinimizeIcon, boolean showCloseIcon,
		boolean resizeable)
	{
...
//		this.controls.setStyleName("gwt-extras-dialog-controls");
	 ...
	 */
	public ResizableDialogBox(boolean autoHide, boolean modal, boolean showMinimizeIcon, boolean showCloseIcon,
		boolean resizeable, Caption caption)
	{
