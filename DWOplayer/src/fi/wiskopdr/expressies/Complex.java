...
public class Complex
{
	...
	*/
	...
	{
		Complex c = new Complex(0.0D, 0.0D);
		if (Complex.infOption && isInfinity(b))
			return c;
	...
	{
		Complex c = new Complex();
		if (Complex.infOption && !isInfinity(a) && b.isInfinite())
			return c;
	...
	{
		Complex c = new Complex(0.0D, 0.0D);
		if (Complex.infOption && !isInfinity(a) && this.isInfinite())
			return c;
	...
	public static Complex pow(Complex a, Complex b)
	{
		...
		if (Math.abs(a.real) < 0.00000000000000001 && Math.abs(a.imag) < 0.00000000000000001)
	...
	public static boolean isEqualDiff(Complex a, Complex b, double diff)
	{
		...
		else
		{
			...
			if (Math.abs(a.real - b.real) < diff && Math.abs(a.imag - b.imag) < diff)
				test = true;
		}
		return test;
	}
	...
	public static boolean isEqualWithinLimits(Complex a, Complex b, double fract)
	{
		...
		if (!test)
		{
			...
			if (Math.abs(ra - rb) / rdn < fract && Math.abs(ia - ib) / idn < fract)
				test = true;
