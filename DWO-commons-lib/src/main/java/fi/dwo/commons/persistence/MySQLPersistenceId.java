...
public class MySQLPersistenceId extends PersistenceId implements Comparable<PersistenceId> {
  ...
  /**
   * This constructor is only public because of jax-rs. Use a factory to generate id's.
   *
   * @param pid
   */
  public MySQLPersistenceId(PersistenceId pid) {
    ...
    if (strList[0].equals("MYSQL")) {
      ...
      LOG.log(Level.FINE, "Set MySQLPersistenceId string {0} and type {1}",
          new Object[] {super.getIdString(), super.getType()});
    } else {
      // super.setType(PersistenceClassType.none);
      LOG.log(Level.SEVERE, "Failed to convert IdString to id and type as it is for DB-type {0}",
          new Object[] {strList[0]});
    }
  }
  ...
  public void setIdString(String idString) {
    ...
    super.setIdString(idString);
    // super.setType(PersistenceClassType.valueOf(strList[1]));
    // LOG.log(Level.FINE, "Set MySQLPersistenceId string {0} and type {1}", new
    // Object[]{super.getIdString(), super.getType()});
    // } else {
    // super.setType(PersistenceClassType.none);
    // LOG.log(Level.SEVERE, "Failed to convert IdString to id and type as it is for
    // DB {0}", new Object[]{strList[0]});
    // }
  }
  //
  // /**
  ...
  private static void checkForMSQLIdent(String id) throws Dwo2Exception {
    if (!id.startsWith("MYSQL")) {
      throw new Dwo2Exception(Dwo2ExceptionCode.PersistentId_ConversionError,
          "Not a MySQL persistenceId string.");
    }
  }
  ...
  private static Long getSingleNativeId(String id, PersistenceClassType type) throws Dwo2Exception {
    ...
    if (!strList[1].equals(type.name())) {
      throw new Dwo2Exception(Dwo2ExceptionCode.PersistentId_ConversionError,
          "Not a valid PersistenceClassType string.");
    }
    return Long.valueOf(strList[2]);
  }

  public static Long getNativeId(DomAppletId o) throws Dwo2Exception {
    return getSingleNativeId(o.getId().getIdString(), PersistenceClassType.PersistentApplet);
  }

  public static Long getNativeId(DomLoginContext o) throws Dwo2Exception {
    return getSingleNativeId(o.getId().getIdString(), PersistenceClassType.PersistentLoginContext);
  }
  ...
  public static Long getNativeId(DomAppletConfigDataId o) throws Dwo2Exception {
    if (o == null) return null;
    return getSingleNativeId(o.getId().getIdString(),
        PersistenceClassType.PersistentAppletConfigData);
  }

  public static Long getNativeId(DomClassCourse o) throws Dwo2Exception {
	if (o == null || o.getId() == null) return null;
  ...
  public static Long getNativeId(DomDwoProfileId o) throws Dwo2Exception {
    if (o == null) return null;
    return getSingleNativeId(o.getId().getIdString(), PersistenceClassType.PersistentDwoProfile);
  }

  // public static String getNativeId(DomDwoSystemParameters o) throws
  // Dwo2Exception{
  // checkForMSQLIdent(o.);
  // String[] strList = id.split(";");
  // return strList[1];
  ...
  public static Long getNativeId(DomSchoolId o) throws Dwo2Exception {
  ...
  public static Long getNativeId(DomStudentScoContext o) throws Dwo2Exception {
    return getSingleNativeId(o.getId().getIdString(),
        PersistenceClassType.PersistentStudentScoContext);
  }
  ...
  /**
   * A class that overrides equals must override hashCode for HasMaps and such to work properly.
   */
  @Override
  public int hashCode() {
  ...
  public static Long getNativeId(DomStudentModelContextId o) throws Dwo2Exception {
    if (o == null) return null;
  ...
  // } else {
  // LOG.log(Level.SEVERE, "Failed to convert IdString {0}", new
  // Object[]{aId.getIdString()});
  // return -1;
  // }
  // }
  //
  // public static MySQLPersistenceId createPersistenceId(long id,
  // PersistenceClassType t) {
  // return new MySQLPersistenceId(id, t);
  // }
  //
  // public static MySQLPersistenceId createPersistentId(PersistentApplet o) {
  // return new MySQLPersistenceId(o.getAppletID(),
  // PersistenceClassType.valueOf(o.getClass().getSimpleName()));
  // }
  //
  // public static MySQLPersistenceId createPersistentId(PersistentAppletConfig o)
  // {
  // return new MySQLPersistenceId(o.getAppletConfigID(),
  // PersistenceClassType.valueOf(o.getClass().getSimpleName()));
  // }
  //
  // public static MySQLPersistenceId createPersistentId(PersistentClassCourse o)
  // {
  // return new MySQLPersistenceId(o.getClassCourseID(),
  // PersistenceClassType.valueOf(o.getClass().getSimpleName()));
  // }
  //
  // public static MySQLPersistenceId createPersistentId(PersistentCourse o) {
  // return new MySQLPersistenceId(o.getCourseID(),
  // PersistenceClassType.valueOf(o.getClass().getSimpleName()));
  // }
  //
  // public static MySQLPersistenceId createPersistentId(PersistentCourseSequence
  // o) {
  // return new MySQLPersistenceId(o.getCoursesequenceID(),
  // PersistenceClassType.valueOf(o.getClass().getSimpleName()));
  // }
  //
  // public static MySQLPersistenceId createPersistentId(PersistentDwoProfile o) {
  // return new MySQLPersistenceId(o.getDwoProfileID(),
  // PersistenceClassType.valueOf(o.getClass().getSimpleName()));
  // }
  //
  //// Don't need this cached.
  //// public static MySQLPersistenceId
  // createPersistenceId(PersistentDwoSystemParameters o) {
  //// return new MySQLPersistenceId(o.getId(),
  // PersistenceClassType.valueOf(o.getClass().getSimpleName()));
  //// }
  // public static MySQLPersistenceId createPersistentId(PersistentHasRole o) {
  // return new MySQLPersistenceId(o.getPersistentHasRolePK().getId(),
  // PersistenceClassType.valueOf(o.getClass().getSimpleName()));
  // }
  //
  ...
  // }
  //
  // public static MySQLPersistenceId createPersistentId(PersistentStudentOfClass
  // o) {
  // MySQLPersistenceId mId = new MySQLPersistenceId();
  // String idString = String.format("MYSQL;%s;%020d;%020d;%020d",
  ...
  //
  // public static MySQLPersistenceId
  // createPersistentId(PersistentStudentScoContext o) {
  // return new MySQLPersistenceId(o.getStudentSco(),
  // PersistenceClassType.valueOf(o.getClass().getSimpleName()));
  // }
  //
  // public static MySQLPersistenceId createPersistentId(PersistentStudentScoData
  // o) {
  // return new MySQLPersistenceId(o.getStudentSco(),
  // PersistenceClassType.valueOf(o.getClass().getSimpleName()));
  // }
  //
  // public static MySQLPersistenceId createPersistentId(PersistentTeacherOfClass
  // o) {
  // return new MySQLPersistenceId(o.getPersistentTeacherOfClassPK().getId(),
  // PersistenceClassType.valueOf(o.getClass().getSimpleName()));
  // }
  //
  ...
  // }
  //
  // public static PersistentHasRolePK extractHasRoleKey(PersistenceId aId) throws
  // Dwo2Exception {
  ...
  public static Long getNativeId(DomMethod o) throws Dwo2Exception {
    if (o.getId() == null) return null;
    return getSingleNativeId(o.getId().getIdString(), PersistenceClassType.PersistentMethod);
  }

  public static Long getNativeId(DomSchoolDataFull o) throws Dwo2Exception {
    if (o.getId() == null) return null;
    return getSingleNativeId(o.getId().getIdString(), PersistenceClassType.PersistentSchoolData);
  }
}
