...
public class PersistentStudentOfClass implements Serializable, PersistentEntity {
    ...
    public PersistentStudentOfClass(Long userID, Long classID, Long schoolGroupID) {
