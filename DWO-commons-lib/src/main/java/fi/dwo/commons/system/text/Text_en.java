...
public class Text_en extends ListResourceBundle {
	...
	private final Object[][] contents = {
			...
			{ TextMapper.LBL_CLICK_TO_SELECT_A_SCHOOLCLASS, "Select a class." },
			...
			{ TextMapper.BTN_ADD, "Add" },
			{ TextMapper.BTN_BACK, "Back" },
			{ TextMapper.BTN_COPYSELECTEDTOCLASS,
					"Copy selected to class" },
			...
			{ TextMapper.BTN_NEW_CLASS, "New class" },
			...
			{ TextMapper.TBL_USERNAME, "Username" },
			{ TextMapper.TBL_PASSWORD, "Password" },
			{ TextMapper.TBL_EMAIL, "Email address" },
			{ TextMapper.TBL_EDITCLASS, "Edit class" },
			{ TextMapper.TBL_EDITMODULES, "Edit modules" },
			{ TextMapper.TBL_EDITSTUDENTS, "Edit students" },
			{ TextMapper.TBL_EDITTEACHERS, "Edit teachers" },
			{ TextMapper.TBL_CLASSNAME, "Class name" },
			{ TextMapper.TBL_CLASSLIST, "Class list" },
			{ TextMapper.TBL_SCHOOLNAME, "Schoolname" },
			{ TextMapper.TBL_SCHOOLLOGIN, "Schoollogin" },
			{ TextMapper.TBL_SCHOOLRIGHTS, "Schoolrights" },
			{ TextMapper.DLG_CONFIRM, "Your action was succesful." },
			...
			{ TextMapper.DLG_DONE_MSG, "Requested task completed." },
                        ...
                        {TextMapper.DLG_Q_REMOVE_SCHOOLCLASS_MEMBERSHIP, "Do you want to deregister for school class \"{0}\"."},
                        {TextMapper.DLG_Q_REMOVE_SCHOOLCLASS_BY_NAME, "Do you want to remove school class \"{0}\"."},
			...
			{TextMapper.DLG_CREATESTUDENTERROR,
					"The remaining students can not be added. Some of the usernames, passwords, or email\n"
                                      + " addresses or usernames may contain illegal tokens. Check the format of the marked\n"
                                      + " field values against the manual."},
			{TextMapper.DLG_COPYSTUDENTERROR,"Some students could not be copied, probabely they were already in the class"},
			{TextMapper.DLG_CREATETEACHERERROR,
					"The remaining teachers can not be added. Some of the usernames, passwords, or email\n"
                                      + " addresses or usernames may contain illegal tokens. Check the format of the marked\n"
                                      + " field values against the manual."},
			{ TextMapper.DLG_NO_USERS_SELECTED, "No users selected." },
			...
			{ TextMapper.EXR_WRONG_USERNAME_PASSWORD,
					"An user with the specified username and password was not found" },
			{ TextMapper.EXR_UNKNOWN_SCHOOLGROUP,
					"Unknown school/group/password combination" },
			{ TextMapper.EXR_MANDATORY,
					"{0} at {1} isn't filled. This is a required field" },
			{ TextMapper.EXR_WRONG_FORMAT,
					"{0} at {1} contains illegal characters" },
			...
			{ TextMapper.EXS_SCHOOL_EXISTS,
					"A school with the specified schoollogin already exists" },
			...
			/* Reauthenticate Panel */
			{
					...
					"<HTML>Are you absolutely sure you want to delete your account, all profiles and all data?<BR> If so, then enter your password and click OK.</HTML>" },
			...
			{ TextMapper.GUIR_OPT_NULLSCHOOL, "No school" },
            ...
            { TextMapper.TBL_RESULTS, "Results" },
			...
			{ TextMapper.GUIP_MY_PROFILE, "My account" },
			{ TextMapper.GUIP_REGISTERINFO, "Account details" },
			{ TextMapper.GUIP_PERSONALINFO, "Personal details" },
			...
			{ TextMapper.GUIP_MSG_PROFILE_CHANGED,
					"Your account is successfully changed" },
			...
			{ TextMapper.GUIS_SCHOOL_NOT_EMPTY,
					"This school contains users. Are you sure you want to delete this school" },
			{ TextMapper.GUIS_SCHOOL_NOT_EMPTY_TITLE,
					"This school contains users." },
			{ TextMapper.GUIS_MSG_DELETE_STUDENT,
					"Are you sure you want to delete {0} from this school" },
			{ TextMapper.GUIS_DELETE_STUDENT,
					"Delete students from this school" },
			{ TextMapper.GUIS_NO_STUDENTS,
					"School {0} doesn't contains students" },
			{ TextMapper.GUIC_STUDENTS, "Students" },
			{ TextMapper.GUIC_CLASS_MANAGEMENT, "My classes" },
			...
			{ TextMapper.GUIC_STUDENTS, "Students" },
			{ TextMapper.GUIC_REGISTER_FOR_CLASS, "Register for class" },
			{ TextMapper.GUIC_DEREGISTER_FOR_CLASS, "Deregister for class" },
			{ TextMapper.GUIC_TBL_CLASSNAME, "Class name" },
			{ TextMapper.GUIC_BTN_SWITCH_CLASS, "Switch to class" },
			...
			{ TextMapper.GUIC_MSG_CLASS_CONFIGURATION, "Class configuration" },
                        { TextMapper.GUIC_MSG_CLASS_NAME, "Class name"},
                        { TextMapper.GUIC_MSG_CLASS_REGISTRATIONKEYQ, "Use a registration key?"},
                        { TextMapper.GUIC_MSG_CLASS_REGISTRATIONKEY, "Registration key"},
                        { TextMapper.GUIC_MSG_CLASS_REGISTRATIONKEY_TOOLTIP, "The registration key can be between 5 and 100 characters long."},
                        { TextMapper.GUIC_MSG_CLASS_TREESTRUCTURE, "Use a tree structure?"},
					...
					"Are you sure you want to delete the class" },
			{
					...
					"There are some students in the class. Are you sure you want to delete the class" },
			{ TextMapper.GUIC_CLASS_NOT_EMPTY_TITLE,
					"There are some students in the class" },
			{ TextMapper.GUIC_MSG_DELETE_STUDENT,
					"Are you sure you want to delete {0} from the class" },
			...
			{ TextMapper.GUISDLG_BTN_PREVIEW_SCO, "Preview Template" },
			{ TextMapper.GUISDLG_MSG_SELECT_SCO, "Choose Template" },
			{ TextMapper.GUISDLG_MSG_NO_APPLETS,
					"There are no Activities to add" },
			{ TextMapper.GUISDLG_SHOW, "Show" },
			{ TextMapper.GUISDLG_ALL, "All" },
			{ TextMapper.GUISDLG_MSG_NO_SELECTION,
					"You haven't selected any Activities" },
			...
			{ "Wilt u alle resultaten van {0} voor {1} verwijderen?",
					"Do you wish to remove all result of {0} for {1}?" },
			{ TextMapper.GUICDLG_SOORT, "Type" },
			{ TextMapper.GUICDLG_VANAF, "From" },
			{ TextMapper.GUICDLG_TOTAAN, "Until" },
			{ TextMapper.GUICDLG_TOT, "Until" },
			{ TextMapper.GUICDLG_LLGGVNS, "Results" },
			{ TextMapper.GUICDLG_NORMAAL, "Normal" },
			{ TextMapper.GUICDLG_AFGESCHERMD, "Secured" },
			{ TextMapper.GUICDLG_ONZICHTBAAR, "Invisible"},
							...
							+ "and can be used at your own school." },
			{
					...
					"<html>I wish to participate in this way of sharing and become visible as school in the lists" },
			{
					TextMapper.GUIEID_MSG3,
					"<html>(1) Select modules<br>(2) Select schools<br><br>The selected modules are available<br>to the selected schools." },
			...
			{ TextMapper.GUIC_SETTINGS_STUDENT,
					"Students choose their own class" },
			...
			// google translate...
			{
					...
					"The subscription for ''{0}'' has expired!\nNew subscribers can no longer be added.\nRefer to the contact person for the DME subscription at school." },
			{ TextMapper.DWOAPPLET_EXISTS, "There is already a DME!" },


			{ TextMapper.FSD_TITLE, "Digital Mathematical Environment" },
			{ TextMapper.FSD_CONFIRM_TITLE, "Do you wish to close?" },
			{ TextMapper.FSD_ACTIVITEIT, "Activity" },
			{ TextMapper.FSD_AFSLUITEN, "Exit and return" },
			{ TextMapper.FSD_SURE, "Are you sure?" },
