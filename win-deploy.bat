...
javapackager -deploy -BappVersion=0.0.1 -Bruntime="%JRE_HOME%" -BjvmOptions=-Xmx1024m -native exe -name Osiris-import -title Osiris-import -vendor Numworx -description "Import OSIRIS files into Numworx" -height 600 -width 800 -appclass nl.numworx.osiris.Main -srcdir target\dependency -outdir target\deploy -outfile Osiris-install
